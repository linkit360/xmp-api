...
type Service struct {
	...
	ServiceOpts string            ``                                       //
	ProvOpts    []ServiceProvOpts `json:"prov_opts,omitempty"`             //
	Content     []Content         `json:"contents,omitempty"`              // Contents of service
	IdContent   string            ``                                       //
}

type ServiceProvOpts struct {
	// QR Tech
...
type Content struct {
	...
	//Blacklist []uint8 `json:"blacklist,omitempty"`   // Blacklisted Countries
}
