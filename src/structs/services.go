...
type ProviderOpts struct {
	...
	SMSOnSubscribe    string `json:"sms_on_unsubscribe,omitempty"`  // Mobilink - Текст СМС, который отправляется при подписке на сервис.
	SMSOnUnsubscribe  string `json:"sms_on_subscribe,omitempty"`    // Mobilink - Текст СМС, который отправляется при отписке от сервиса.
	...
	PeriodicDays      string `json:"periodic_days,omitempty"`       // Mobilink - days of week to charge subscriber
